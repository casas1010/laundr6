...
export const GOOGLE_MAPS_KEY = "AIzaSyD0MtG3cTrc_rEx7fQLRZIDCZgfiJkwrW8";

export const BASE_URL= 'http://laundrwebappbackend-test.us-east-2.elasticbeanstalk.com'
