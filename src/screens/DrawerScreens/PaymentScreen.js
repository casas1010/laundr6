...
const PaymentScreen = () =>{
    ...
    const _handlePressButtonAsync = async () => {
        let result = await WebBrowser.openBrowserAsync('https://www.laundr.io/my-account/add-payment-method/');
        this.setState({ result });
      };

    return (
        <View style={styles.container}>
          <BUTTON text="Input payment information" onPress={_handlePressButtonAsync} />
...
//         <Header openDrawer={() => props.navigation.navigate("Home")} name="Account" />
